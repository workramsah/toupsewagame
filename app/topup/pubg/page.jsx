            ...
            <div className="flex flex-col items-center">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                        <div onClick={() => setPrice(169)} className="bg-orange-400 w-44 h-16 flex flex-col justify-center rounded-lg hover:ring-2 ">
                            <div className="flex justify-between px-2" >
                                <h1>60 UC</h1> <img src="/uc.png" className="w-5 h-5"></img>
                            </div>
                            <h1 className="px-2">Rs 169</h1>
                        </div>
                        <div onClick={() => setPrice(749)} className="bg-orange-400 w-44 h-16 flex flex-col justify-center rounded-lg hover:ring-2 ">
                            <div className="flex justify-between px-2" >
                                <h1>300+25 UC</h1> <img src="/uc.png" className="w-5 h-5"></img>
                            </div>
                            <h1 className="px-2">Rs 749</h1>
                        </div>
                        <div onClick={() => setPrice(1496)} className="bg-orange-400 w-44 h-16 flex flex-col justify-center rounded-lg hover:ring-2 ">
                            <div className="flex justify-between px-2" >
                                <h1>600+60 UC</h1> <img src="/uc.png" className="w-5 h-5"></img>
                            </div>
                            <h1 className="px-2">Rs 1496</h1>
                        </div>
